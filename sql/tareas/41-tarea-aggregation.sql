...
SELECT COUNT(*) AS total FROM users WHERE country = 'Iceland' AND last_connection LIKE '112.%';

-- 6. Listado de usuarios de Iceland, tienen dirección IP que inicia en 112 ó 28 ó 188
...
-- 8. Listado de personas cuyo país está en este listado ('Mexico', 'Honduras', 'Costa Rica')
...
ORDER BY
    ...
    first_name ASC,
    last_name ASC;
-- 9. Del query anterior, cuente cuántas personas hay por país. Ordene los resultados por País asc
SELECT
    COUNT(*) AS total,
    country
FROM
